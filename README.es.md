...
- La interfaz de terminal se transmite en tiempo real y es interactiva. Puedes detener e intervenir en cualquier momento. Si ves que tu agente se dirige en la dirección equivocada, simplemente detente y díselo de inmediato.
...
- Con un prompt del sistema sólido, el framework es confiable incluso con modelos pequeños, incluyendo el uso preciso de herramientas.
