...
- 开发者和贡献者：从[发布页面](https://github.com/frdel/agent-zero/releases)下载适合你系统的完整二进制文件，然后按照[此处提供的说明](./docs/installation.md#in-depth-guide-for-full-binaries-installation)进行操作。
